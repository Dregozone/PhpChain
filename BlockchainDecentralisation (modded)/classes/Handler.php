<?php 
    ...
    Class Handler 
    {
        ...
        public function __construct($user) {
            ...
            $this->user = $user;
            $this->file = '../../BlockchainDecentralisation/data/' . $user . '.json';

            if ( file_exists("../../BlockchainDecentralisation/data/".$user.".port") ) { // If the user has been on the network before
                $this->port = (int)file_get_contents("../../BlockchainDecentralisation/data/".$user.".port"); // Grab the port for this user
            } else {
                die("User not found!");
            }
        }
